...
angular.module('djangular-demo').config(function($stateProvider, $urlRouterProvider) {
    ...
    $stateProvider
        ...
        .state('comparator', {
            url: '/comparator',
            templateUrl: "/static/data/angulartemplate/comparator/template.html",

            controller: 'Comparator_Ctrl'
        })

        // nested states 
        // each of these sections will have their own view
        // url will be nested (/form/profile)
        .state('comparator.pet', {
            url: '/pet',
            data: {
                pageTitle: 'Select your pet'},

            templateUrl: "/static/data/angulartemplate/comparator/pet.html",

        })


        .state('comparator.research_term', {
            url: '/food',
            data: {
                pageTitle: 'Set up the Petfood filter'},
            templateUrl: "/static/data/angulartemplate/comparator/research_term.html",

        })

        .state('comparator.result', {
            url: '/result',
            data: {
                pageTitle: 'Results !'},
            templateUrl: "/static/data/angulartemplate/comparator/result.html",
    ...
    $urlRouterProvider.otherwise('/comparator/pet');
...
.controller('Comparator_Ctrl', function($scope, $http, $window,$filter,breed,list_of_pets,list_of_petfood_zooplus_dog,list_of_petfood_zooplus_dog,list_of_petfood_zooplus_cat,list_of_petfood_zooplus_dog_by_brand,petfood_zooplus_dog_filter,petfood_zooplus_cat_filter,list_of_pets,pet_by_id,$uibModal) {
...
$scope.tag_targeted_life_stage=''
$scope.tag_spec=''

$scope.user={}
$scope.user.wished_status=''
$scope.user.wished_spec=''
